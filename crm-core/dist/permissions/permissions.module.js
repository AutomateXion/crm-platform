...
exports.PermissionsModule = PermissionsModule = __decorate([
    (0, common_1.Module)({
        imports: [
            typeorm_1.TypeOrmModule.forFeature([permission_entity_1.Permission, module_entity_1.AppModule, sub_module_entity_1.SubModule, sub_module_entity_1.Page, sub_module_entity_1.Field, user_group_entity_1.UserGroup]),
        ],
