...
__decorate([
    (0, swagger_1.ApiProperty)({ example: 'ACME_CORP', description: 'Your company tenant code' }),
    (0, class_validator_1.IsString)(),
    __metadata("design:type", String)
], LoginDto.prototype, "tenantCode", void 0);
__decorate([
    (0, swagger_1.ApiPropertyOptional)({ example: '123456', description: '6-digit 2FA code if enabled' }),
