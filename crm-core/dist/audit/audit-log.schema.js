...
__decorate([
    (0, mongoose_1.Prop)(),
    __metadata("design:type", String)
], AuditLog.prototype, "entityLabel", void 0);
__decorate([
    (0, mongoose_1.Prop)({ type: [{ field: String, oldValue: String, newValue: String }], default: [] }),
...
__decorate([
    (0, mongoose_1.Prop)({ index: true, default: Date.now }),
    __metadata("design:type", Date)
], AuditLog.prototype, "timestamp", void 0);
exports.AuditLog = AuditLog = __decorate([
    (0, mongoose_1.Schema)({ collection: 'audit_logs', timestamps: true })
], AuditLog);
