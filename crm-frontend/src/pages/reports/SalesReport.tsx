          ...
          items={[
            {
              ...
              children: (
                <>
                  ...
                  <Table dataSource={data.byCustomer || []} columns={customerCols} rowKey="name" size="small" loading={loading} pagination={{ showSizeChanger: true, pageSizeOptions: ['10','20','50','100'], defaultPageSize: 15 }} />
                </>
              ),
            },
            {
